...
export const SCHEMA_CONTRACT: TableColumns = {
  ...
  places: ["id", "trip_id", "fsq_place_id", "name", "lat", "lng", "category", "source", "suggested_by", "hours_json", "price_band", "score", "note", "created_at"],
  ...
  multiplier_days: ["id", "trip_id", "local_date", "multiplier", "label", "source", "created_at"],
};
