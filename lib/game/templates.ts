...
export const TEMPLATES: TaskTemplate[] = [
  ...
  // SIDEQUESTS: short, bold, never on the board (duration "sidequest").
  // Delivered by lib/handlers/sidequests.ts; the sidequest level (1 civilized,
  // 2 questionable, 3 feral) caps boldness. Wording is a first draft.
  {
    id: "sq_colour_match",
    archetype: "find something the exact colour of what you're wearing, within five minutes' walk",
    kind: "explore",
    slots: [],
    verification: "photo",
    photo_bonus_max: 1,
    axes: axes(range(1, 1), range(1, 2), range(1, 1), range(2, 3), range(1, 2), range(2, 3)),
    indoor: false,
    typical_cost: "low",
    duration: "sidequest",
    fixedMinutes: 10,
  ...
  {
    id: "sq_weird_sign",
    archetype: "photograph the weirdest sign you can find in ten minutes",
    kind: "explore",
    slots: [],
    verification: "photo",
    photo_bonus_max: 1,
    axes: axes(range(1, 2), range(1, 2), range(1, 1), range(2, 3), range(2, 3), range(1, 2)),
    indoor: false,
    typical_cost: "low",
    duration: "sidequest",
    fixedMinutes: 10,
  ...
  {
    id: "sq_local_thanks",
    archetype: "learn how to say thank you like a local, from a local, and use it on the next person you pay",
    kind: "social",
    slots: [],
    verification: "honor",
    photo_bonus_max: 0,
    axes: axes(range(3, 3), range(1, 1), range(1, 1), range(1, 2), range(3, 4), range(1, 1)),
    indoor: false,
    typical_cost: "low",
    duration: "sidequest",
    fixedMinutes: 10,
  ...
  {
    id: "sq_stranger_pose",
    archetype: "ask a stranger to take your photo in a pose they choose",
    kind: "social",
    slots: [],
    verification: "photo",
    photo_bonus_max: 1,
    axes: axes(range(3, 4), range(1, 1), range(1, 1), range(1, 2), range(1, 2), range(2, 3)),
    indoor: false,
    typical_cost: "low",
    duration: "sidequest",
    fixedMinutes: 10,
  ...
  {
    id: "sq_sing_a_line",
    archetype: "sing one line of a song out loud, in public, somewhere with people around",
    kind: "challenge",
    slots: [],
    verification: "honor",
    photo_bonus_max: 0,
    axes: axes(range(4, 5), range(1, 1), range(1, 1), range(1, 1), range(1, 2), range(1, 1)),
    indoor: false,
    typical_cost: "low",
    duration: "sidequest",
    fixedMinutes: 5,
  ...
  {
    id: "sq_high_five",
    archetype: "get a high five from a stranger without explaining why",
    kind: "social",
    slots: [],
    verification: "honor",
    photo_bonus_max: 0,
    axes: axes(range(4, 5), range(1, 1), range(1, 1), range(1, 2), range(1, 1), range(1, 1)),
    indoor: false,
    typical_cost: "low",
    duration: "sidequest",
    fixedMinutes: 5,
