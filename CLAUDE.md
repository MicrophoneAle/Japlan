...
- 24 templates in `lib/game/templates.ts` (21 main, 3 sidequest-only); wording of the 19 added 2026-09-19 is a first draft. The venue time table in `lib/game/duration.ts` and the pace windows in `lib/game/day-plan.ts` are hand-set estimates, not measured.
